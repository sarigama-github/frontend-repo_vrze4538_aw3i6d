    ...
    <section id="about" className="relative bg-neutral-950 py-20 text-neutral-50">
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        <header className="mb-10">
          <p className="text-[11px] uppercase tracking-[0.3em] text-white/60">Profilo</p>
          ...
          <div className="md:col-span-7 md:pl-10">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <div className="rounded-md border border-white/10 p-4 text-center">
                ...
                <div className="mt-1 text-xs uppercase tracking-widest text-white/60">Anni</div>
              </div>
              <div className="rounded-md border border-white/10 p-4 text-center">
                <div className="text-2xl font-semibold">50+</div>
                <div className="mt-1 text-xs uppercase tracking-widest text-white/60">Progetti</div>
              </div>
              <div className="rounded-md border border-white/10 p-4 text-center">
                <div className="text-2xl font-semibold">15</div>
                <div className="mt-1 text-xs uppercase tracking-widest text-white/60">Premi</div>
              </div>
            </div>

            <blockquote className="mt-8 rounded-md border border-white/10 p-6 text-sm leading-relaxed text-white/80">
